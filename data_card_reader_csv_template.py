...
class DataCardReader:
    ...
    def create(self, file_path, train_path, test_path):
    ...
    def create_json(self, card):
        return makejson(card)

    def save(self, data_card, save):
        validate_save(data_card, save)
    ...
    def create_data_card_metadata(self, name='Input Required', version='Input Required',
                                  keyword=['Input Required', 'Input Required'], description='Input Required', publisher='Input Required',
...
if __name__ == '__main__':
    ...
    card = DataCardReader()
    output = card.create(file_path, train_path, test_path)
    card.save(output, save)
